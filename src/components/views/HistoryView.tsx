...
export const HistoryView: React.FC<{
  ...
  <div className="h-full overflow-y-auto">
    <div className="px-10 py-8 border-b border-ink-200 flex items-end justify-between">
      <div>
    ...
    {runs.length === 0 ? (
      ...
      <table className="w-full">
        <thead>
          <tr className="text-left font-mono text-xs tracking-wider text-ink-400 border-b border-ink-200">
        ...
        <tbody>
          {runs.map((r) => {
            ...
            return (
              <tr key={r.id} onClick={() => onOpen(r)} className="border-b border-ink-200 hover:bg-ink-50 cursor-pointer">
