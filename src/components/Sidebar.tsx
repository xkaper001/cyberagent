...
export const Sidebar: React.FC<{
  ...
  <nav className="w-56 shrink-0 border-r border-ink-300 bg-ink-50 flex flex-col">
    <div className="h-20 flex items-center gap-2 px-6 border-b border-ink-300">
    ...
    <div className="px-6 py-4 border-t border-ink-300">
